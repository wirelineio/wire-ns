...
```json
  {
    ...
    "type": "wrn:resource",
    "name": "wireline/xbox:devnet-unstable",
    "version": "0.1.29",
    "owners": [
    ...
    "attributes": {
      ...
      "docker": {
        ...
        "url": "https://hub.docker.com/layers/wireline/xbox/devnet-unstable-0.1.29/images/sha256-df9cb3caa90fa8240dbeb4c3497f74d19d545897ae256bcafc4d3976c5c7940e"
      },
      "name": "wireline/xbox:devnet-unstable",
      "type": "wrn:resource"
    }
...
```json
  {
    ...
    "attributes": {
      ...
      "version": "0.0.1",
      "wns": {
        "rpc": "tcp://node1.wireline.network:26657"
      }
    }
  }
```
...
```json
{
  "record": {
    ...
    "signal": {
        "url": "wss://my.host.name/wireline/signal",
